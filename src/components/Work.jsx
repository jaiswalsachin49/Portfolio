    ...
    return (
        ...
        <div className="flex flex-col items-center w-full pt-30">
            ...
            <div className="flex justify-center items-center gap-50 relative z-10 -top-20">
                ...
                className="w-100 rounded-2xl shadow-lg transform transition-transform duration-500 ease-in-out rotate-[265deg] group-hover:rotate-270"
                />
                <img
                src="/zooper2.jpeg"
                alt="Zooper Screenshot"
                className="w-150 h-auto rounded-2xl shadow-lg transform transition-transform duration-500 ease-in-out rotate-[5deg] group-hover:rotate-0"
                />
            </div>
            </motion.div>
            ...
            <div className="flex justify-center items-center gap-10 relative z-10 mt-8">
                ...
                alt="Chef Screenshot"
                className="w-170 rounded-2xl shadow-lg transform transition-transform duration-500 ease-in-out rotate-[-5deg] group-hover:rotate-0"
                />
                <img
                src="/chef_claude2.png"
                alt="Chef Screenshot"
                className="w-170 h-auto rounded-2xl shadow-lg transform transition-transform duration-500 ease-in-out rotate-[5deg] group-hover:rotate-0"
                />
            </div>
            </motion.div>
